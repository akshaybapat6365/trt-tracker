      ...
      days.push(
        <div
          ...
          className={`
            ...
            ${isInjection ? 'border-amber-500/20' : ''}
          `}
          onClick={() => isInjection && onDateClick?.(date)}
        >
          {/* Hover glow effect */}
          <div className="absolute inset-0 bg-gradient-to-br from-amber-500/0 via-amber-500/10 to-amber-500/0 
  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-10 flex flex-wrap gap-4">
        <div className="flex items-center gap-3 px-5 py-3 bg-zinc-950 border border-zinc-900/50 rounded-xl">
